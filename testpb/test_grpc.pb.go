...
type TestServiceClient interface {
	GestTest(ctx context.Context, in *GetTestRequest, opts ...grpc.CallOption) (*Test, error)
...
func (c *testServiceClient) GestTest(ctx context.Context, in *GetTestRequest, opts ...grpc.CallOption) (*Test, error) {
	out := new(Test)
	err := c.cc.Invoke(ctx, "/test.TestService/GestTest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TestServiceServer interface {
	GestTest(context.Context, *GetTestRequest) (*Test, error)
...
func (UnimplementedTestServiceServer) GestTest(context.Context, *GetTestRequest) (*Test, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GestTest not implemented")
}
...
func _TestService_GestTest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTestRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TestServiceServer).GestTest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/test.TestService/GestTest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServiceServer).GestTest(ctx, req.(*GetTestRequest))
	}
...
var TestService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GestTest",
			Handler:    _TestService_GestTest_Handler,
		},
		{
			MethodName: "SetTest",
